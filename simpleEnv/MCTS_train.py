...
from simpleEnv.env import SnakeEnv
from simpleEnv.MCTS_game import Game
from simpleEnv.MCTS_alphaZero import MCTSPlayer
from simpleEnv.MCTS_policy_value_net_tensorflow import PolicyValueNet  # Tensorflow
...
if __name__ == '__main__':
    ...
    if train_model:
        training_pipeline = TrainPipeline(trainSpeed=0, train_model=False) # 这个参数train是选择是不是开图像
        training_pipeline.run()
    else:
        inference_pipline = Inference_Pipeline(gameSpeed=1, train_model = False)
